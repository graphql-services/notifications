module github.com/graphql-services/notifications
...
require (
	...
	github.com/graphql-services/go-saga v0.0.0-20190917142920-46ab02eae4de
	...
	github.com/novacloudcz/graphql-orm v0.4.18
